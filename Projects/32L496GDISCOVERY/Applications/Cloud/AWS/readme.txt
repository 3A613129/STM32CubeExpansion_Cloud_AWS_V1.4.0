...
This application implements an Amazon AWS Cloud IoT client for the STM32L496G-Discovery board
using an external xG96 Quectel cellular modem connected via the STmod+ connector,
...
@par Hardware and Software environment
  ...
  - Quectel xG96 daughterboard connected to the MCU board IO expander: Modem package upside, SIM card slot downside.

    BG96 is the modem used by default. In case you have a UG96, you may want to activate the UG96 experimental support
    by defining the USE_MODEM_UG96 compilation switch in your project instead of USE_MODEM_BG96.
  ...
  - Modem Firmware upgrade
    * The Firmware modem (xG96) may need to be upgraded. Most of time it is preferable to migrate to the latest version.
...
For the application to work, you must do the following:
 ...
 - Program the firmware on the STM32 board: If you generated a raw binary file,
   ...
   Projects\STM32L496G-Discovery\Applications\Cloud\AWS\<toolchain>\PostBuild\SBSFU_<boardname>_AWS.bin
